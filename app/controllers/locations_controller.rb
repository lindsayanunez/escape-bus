class LocationsController < ApplicationController
  include LocationsHelper #module with our helper method
  ...
  def show
    ...
    #Use our helper method to parse the data from our API
    @buses = fetch_api_data(source)

    #Loop through all buses to and return only those that are nearby
    @nearby_buses = []
    @buses.each do |bus|
